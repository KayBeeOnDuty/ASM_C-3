    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "123 Nguyễn Trãi, Hà Nội", "0123 456 789", "Tea & Coffee Co." },
                    { 2, "45 Lê Lợi, TP. Hồ Chí Minh", "0987 654 321", "Milk Supply Ltd." },
                    { 3, "22 Trần Phú, Đà Nẵng", "0765 432 100", "SugarHouse" }
                });
